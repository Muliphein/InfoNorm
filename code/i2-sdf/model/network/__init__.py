...
class I2SDFNetwork(nn.Module):
    def __init__(self, conf):
        ...
        self.with_dn_dw = self.implicit_network.with_dn_dw
    ...
    def forward(self, input, predict_only=False):
        ...
        if self.training:
            ...
            if self.with_dn_dw:
                dn_dw_feature = dn_dw_feature.reshape(batch_size, N_samples, -1)
...
class I2SDFLoss(nn.Module):
    def __init__(
            ...
            bubble_weight=0.0,
            min_bubble_iter=0,
            max_bubble_iter=None,
            smooth_iter=None,
            light_mask_weight=0.0,
            eikonal_weight_bubble=0.0,
            jacobi_contrastive_weight=0.0,
        ...
        self.jacobi_gradient_weight = jacobi_gradient_weight
    ...
    def forward(self, model_outputs, ground_truth, current_step):
        ...
        if 'jaco_info' in ground_truth and (self.jacobi_contrastive_weight>0 or self.jacobi_gradient_weight>0):
        ...
        #     try:
        #         print('Normal Loss = ', self.normal_weight * normal_loss.item())
        #     except:
        #         pass
        #     try:
        #         print('Angular Loss = ', self.angular_weight * angular_loss.item())
        #     except:
        #         pass
        #     try:
        #         print('Depth Loss = ', self.depth_weight * depth_loss.item())
        #     except:
        #         pass
        #     try:
        #         print('Jaco con Loss = ', self.jacobi_contrastive_weight * jaco_con_loss.item())
        #     except:
        #         pass
        #     try:
        #         print('Jaco gra Loss = ', self.jacobi_gradient_weight * jaco_gra_loss.item())
        #     except:
        #         pass
                      ...
                      self.bubble_weight * bubble_loss + \
                       self.light_mask_weight * light_mask_loss +\
                        self.jacobi_contrastive_weight * jaco_con_loss +\
                         self.jacobi_gradient_weight * jaco_gra_loss
